...
def _backup(install: locate.Installation, pristine: Bundle) -> Path:
    ...
    over the only pristine copy there was. Every shipped build carries ~154 MB
    of bytecode and every binary we write has none, so a bundle with any was not
    written by us, whatever the fingerprint says.
    """
